...
const GifIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#bbb" strokeWidth="2">
    ...
    <text x="5.5" y="16" fontSize="7" fill="#bbb" fontWeight="800" stroke="none" fontFamily="sans-serif">GIF</text>
  </svg>
);
...
export default function PostCard({ post, index }) {
  ...
  let imgStyle = {};
  if (post.id === 2) {
    imgStyle = { height: 500 }; // taller image
  } else {
    imgStyle = { height: 250, width: "100%" }; // square
  }

  return (
    <div style={{ background: "#fff" }}>
      <div style={{ display: "flex", alignItems: "flex-start", gap: 10, padding: "16px 16px 0" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 8 }}>
            <div>
              ...
              <div style={{
                fontSize: 11, color: "#999", fontFamily: "'Instrument Sans', sans-serif",
                marginTop: 1
              }}>
                {post.handle} | {post.category.charAt(0) + post.category.slice(1).toLowerCase()}
              </div>
              <div style={{
                fontSize: 10, color: "#c0b8b0", fontFamily: "'Instrument Sans', sans-serif",
                marginTop: 1
              }}>
                Hong Kong · Jun 2024
              </div>
          ...
          {/* Excerpt */}
          <p style={{
            margin: "0 0 12px", fontSize: 12, color: "#888", fontFamily: "'Instrument Sans', sans-serif",
            lineHeight: 1.65
          }}>
          ...
          {/* Engagement — icon only row matching the screenshot */}
          <div
            style={{
              display: "flex",
              alignItems: "center",
          ...
          >
            ...
            <button
              ...
              style={{ ...iconBtn, color: liked ? "#e74c3c" : "#555" }}
            >
